...
<head>
    ...
    <meta name="description" content="Open Vessel Data Management v2.9 (OpenVDM)">
    ...
    if (isset($data['css'])){
        foreach ($data['css'] as &$cssFile) {
            if ($cssFile === 'leaflet') {
                ...
                array_push($cssFileArray, DIR . 'bower_components/leaflet-fullscreen/dist/leaflet.fullscreen.css');
