...
?>
    ...
    <div class="row">
                    ...
                    <?php echo Form::open(array('role'=>'form', 'method'=>'post')); ?>
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="form-group">
                                    <label><?php echo CRUISE_NAME; ?> Data Directory</label><?php echo Form::input(array('class'=>'form-control', 'type'=>'text', 'name'=>'destDir', 'value'=>$data['shoresideDataWarehouseConfig']['destDir'])); ?>
                                </div>
                                <div class="form-group">
        ...
        <div class="col-lg-6">
            ...
            <p>Starting with v2.11 OpenVDM is transitioning from rsync to rclone for ship-to-shore transfers.  Use the format of <code>rclone_remote:destination_directory</code> to instruct OpenVDM to use rclone for ship-to-shore transfers. Currently only GCS and SFTP remote types are supported.  Example GCS: <code>ship-to-shore-gcs:shoreside_bucket/</code> Example SFTP: <code>ship-to-shore-sftp:/data/shoreside</code>  The rclone remotes must be setup via <code>rclone config</code> prior to use.</p>
