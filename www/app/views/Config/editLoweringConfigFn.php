    ...
    <div class="row">
        <div class="col-lg-6">
            <div class="panel panel-default">
                <div class="panel-heading">Edit <?php echo LOWERING_NAME ?> Config File</div>
        ...
        <div class="col-lg-6">
            ...
            <p>The <strong>File Name</strong> field is the file name (i.e. loweringConfig.json).  The filename should end in '.json' and contain no spaces.</p>
