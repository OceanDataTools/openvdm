    ...
    <div class="row">
        <div class="col-lg-6">
            <div class="panel panel-default">
                <div class="panel-heading">Edit <?php echo CRUISE_NAME ?> Config File</div>
        ...
        <div class="col-lg-6">
            <h3>Page Guide</h3>
            <p>This form is for editing the name of the cruise configuration file.</p>
            <p>The <strong>File Name</strong> field is the file name (i.e. ovdmConfig.json).  The filename should end in '.json' and contain no spaces.</p>
