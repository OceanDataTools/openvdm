...
$_POST += ['name' => '', 'longName' => '', 'includeFilter' => ''];
    ...
    <div class="row">
        <div class="col-lg-6">
            <div class="panel panel-default">
                <div class="panel-heading">Add new Ship-to-Shore Transfer</div>
        ...
        <div class="col-lg-6">
            <h3>Page Guide</h3>
            <p>This form is for adding a new Ship-to-Shore Transfer within OpenVDM. A Ship-to-Shore Transfers specifies subsets of the cruise data directory that should be queued for transfer to the Shoreside Data Warehouse (SSDW).</p>
            ...
            <p>Click the <strong>Add</strong> button to submit the Ship-to-Shore Transfer to OpenVDM.  Click the <strong>Cancel</strong> button to exit this form.</p>
        </div>
    </div>
