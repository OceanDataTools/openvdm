                    ...
                    <?php echo Form::open( array('role'=>'form', 'method'=>'post', 'files')); ?>
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="form-group staleness"><label>Remove source files after copy (--remove-source-files)?</label> <?php echo FormCustom::radioInline($data['stalenessOptions'], $_POST['removeSourceFiles']); ?></div>
