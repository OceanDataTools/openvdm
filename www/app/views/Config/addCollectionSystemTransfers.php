                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <span class="pull-right staleness">
                                        <label>Time to wait when checking for active writes (seconds)?</label><?php echo Form::input( array('name'=>'customStaleness', 'value'=> ($_POST['staleness'] != "0")? $_POST['staleness'] : "5", 'size'=>'7', 'length'=>'8')); ?>
                                    </span>
                                </div>
