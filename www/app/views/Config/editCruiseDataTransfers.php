                    ...
                    <?php echo Form::open( array('role'=>'form', 'method'=>'post')); ?>
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="form-group"><label>Sync (--delete) with destination directory?</label><?php echo FormCustom::radioInline($data['syncToDestOptions'], $data['row'][0]->syncToDest); ?></div>
