...
$data['row'][0]->excludedCollectionSystems = explode(',', $data['row'][0]->excludedCollectionSystems);
$data['row'][0]->excludedExtraDirectories = explode(',', $data['row'][0]->excludedExtraDirectories);
    ...
    <div class="row">
        <div class="col-lg-6 col-md-7">
            <div class="panel panel-default">
                <div class="panel-heading">Edit <?php echo CRUISE_NAME; ?> Data Transfer</div>
                    ...
                    <?php echo Form::open( array('role'=>'form', 'method'=>'post')); ?>
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="form-group rsyncServer"><label>Rsync password</label><?php echo Form::input( array('class'=>'form-control', 'name'=>'rsyncPass', 'type'=>'password', 'placeholder'=>(!empty($data['pendingPasswords']['rsyncPass']) ? '(new password retained from test - leave blank to use it)' : '(leave blank to keep existing)'))); ?></div>
                                ...
                                <div class="form-group smbShare"><label>SMB Password</label><?php echo Form::input( array('class'=>'form-control', 'name'=>'smbPass', 'type'=>'password', 'placeholder'=>(!empty($data['pendingPasswords']['smbPass']) ? '(new password retained from test - leave blank to use it)' : '(leave blank to keep existing)'))); ?></div>
                                ...
                                <div class="form-group sshServer"><label>SSH Password</label><?php echo Form::input( array('class'=>'form-control', 'name'=>'sshPass', 'type'=>'password', 'placeholder'=>(!empty($data['pendingPasswords']['sshPass']) ? '(new password retained from test - leave blank to use it)' : '(leave blank to keep existing)'))); ?></div>
<?php
