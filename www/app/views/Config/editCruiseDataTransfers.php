                    ...
                    <?php echo Form::open( array('role'=>'form', 'method'=>'post')); ?>
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="form-group rsyncServer"><label>Rsync password</label><?php echo Form::input( array('class'=>'form-control', 'name'=>'rsyncPass', 'type'=>'password', 'placeholder'=>(!empty($data['pendingPasswords']['rsyncPass']) ? '(new password retained from test - leave blank to use it, click Update to save it)' : '(leave blank to keep existing)'))); ?></div>
                                ...
                                <div class="form-group smbShare"><label>SMB Password</label><?php echo Form::input( array('class'=>'form-control', 'name'=>'smbPass', 'type'=>'password', 'placeholder'=>(!empty($data['pendingPasswords']['smbPass']) ? '(new password retained from test - leave blank to use it, click Update to save it)' : '(leave blank to keep existing)'))); ?></div>
