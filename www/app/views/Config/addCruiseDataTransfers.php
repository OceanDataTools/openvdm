    ...
    <div class="row">
        <div class="col-lg-6 col-md-7">
            <div class="panel panel-default">
                <div class="panel-heading">Add new <?php echo CRUISE_NAME; ?> Data Transfer</div>
...
?>
        ...
        <div class="col-lg-6 col-md-5">
            <h3>Page Guide</h3>
            <p>This form is for adding a new <?php echo CRUISE_NAME; ?> Data Transfer to OpenVDM. A <?php echo CRUISE_NAME; ?> Data Transfer is an OpenVDM-managed copy of all collected data from the current cruise data directory on the Shipboard Data Warehouse to a remote server, NAS box or external HDD connected to the Shipboard Data Warehouse.</p>
            ...
            <p>The <strong>Destination Directory</strong> is the location where the cruise data will be copied to. Starting in version 2.12 you can perform a local transfer to a rclone remote destination (i.e. Google Cloud Storage). To do this a rclone remote config must be defined for the root user via <code>rclone config</code>. Once the rclone remote is configured request it via \<rclone_remote\>:\<remote_dir\> or in the case of something like a GCS: via \<rclone_remote\>:\<bucket_name\>/\<remote_dir\>.</p>
