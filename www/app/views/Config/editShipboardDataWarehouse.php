...
?>
    ...
    <div class="row">
                    ...
                    <?php echo Form::open(array('role'=>'form', 'method'=>'post')); ?>
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="form-group">
                                    <label><?php echo CRUISE_NAME; ?> Data Base Directory</label><?php echo Form::input(array('class'=>'form-control', 'type'=>'text', 'name'=>'shipboardDataWarehouseBaseDir', 'value'=>$data['shipboardDataWarehouseConfig']['shipboardDataWarehouseBaseDir'], 'disabled'=>'disabled')); ?>
                                </div>
                                <div class="form-group">
                                    <label><?php echo CRUISE_NAME; ?> Data Apache Directory</label><?php echo Form::input(array('class'=>'form-control', 'type'=>'text', 'name'=>'shipboardDataWarehouseApacheDir', 'value'=>$data['shipboardDataWarehouseConfig']['shipboardDataWarehouseApacheDir'], 'disabled'=>'disabled')); ?>
                                </div>
                                <div class="form-group">
        ...
        <div class="col-lg-6">
            ...
            <p>The <strong><?php echo CRUISE_NAME; ?> Data Base Directory</strong> is the location of the parent directory to the <?php echo CRUISE_NAME; ?> Data Directories on the SBDW (i.e. "/mnt/vault/CruiseData").  This is defined in the OpenVDM web-application configuration file and can not be edited here.</p>
            ...
            <p>The <strong>Public Data Directory</strong> is the location of the PublicData directory on the SBDW. (i.e. "/mnt/vault/PublicData").  This is defined in the OpenVDM web-application configuration file and can not be edited here.</p>
