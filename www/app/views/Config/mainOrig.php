...
<?php
    if($enableSSDW) {
?>
                            Ship-to-Shore Transfers<a href="<?php echo DIR; ?>config/disableShipToShoreTransfers" class="pull-right btn btn-xs btn-success <?php echo ($data['systemStatus']? '': 'disabled'); ?>">On</a>
<?php
    } else {
?>
                            Ship-to-Shore Transfers<a href="<?php echo DIR; ?>config/enableShipToShoreTransfers" class="pull-right btn btn-xs btn-danger <?php echo ($data['systemStatus']? '': 'disabled'); ?>">Off</a>
<?php
    }
?>
                        </div>
