...
VALUES
  ...
  (6,'cruiseEndDate',''),
  (7,'cruiseSize','0'),
  (8,'cruiseSizeUpdated','2022/01/01 00:00:00'),
  (9,'loweringID','Test_Lowering'),
  (10,'loweringStartDate','2022/01/01 00:00'),
  (11,'loweringEndDate',''),
  (12,'loweringSize','0'),
  (13,'loweringSizeUpdated','2022/01/01 00:00:00'),
  (14,'systemStatus','Off'),
  (15,'shipToShoreBWLimitStatus','Off'),
  (16,'md5FilesizeLimit','10'),
  (17,'md5FilesizeLimitStatus','On'),
  (18,'showLoweringComponents','No'),
